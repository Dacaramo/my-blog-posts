...
description: "Just want to have a fully serverless backend running on serverless functions, but you don't want to manually create all of your cloud service provider resources manually? Don't worry, the Serverless Framework is here to rescue you."
date: '2024-01-14'
