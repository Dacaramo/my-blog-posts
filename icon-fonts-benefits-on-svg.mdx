...
description: 'Sometimes you just want to follow a single code implementation when styling icons, no matter if it's a custom svg icon or a third party library font based icon. Let's learn how to make every icon follow the styles specified on it's parent element'
date: '2023-10-25'
